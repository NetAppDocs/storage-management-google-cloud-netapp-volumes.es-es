...
NOTE: Para entornos de ensayo, usa `credentials-sa@wf-staging-netapp.iam.gserviceaccount.com` en lugar de la cuenta de servicio de producción. Reemplaza el valor del parámetro `--member` en el comando anterior por `serviceAccount:credentials-sa@wf-staging-netapp.iam.gserviceaccount.com`.
