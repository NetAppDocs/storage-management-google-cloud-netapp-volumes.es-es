...
Los volúmenes creados por Google Cloud NetApp Volumes se cargan a su suscripción al servicio, no a través de la consola de NetApp .

No hay ningún cargo por descubrir una región o un volumen de Google Cloud NetApp Volumes desde la consola de NetApp .
...
* https://docs.netapp.com/us-en/data-services-copy-sync/index.html["Documentación de copia y sincronización de la consola de NetApp"^]
